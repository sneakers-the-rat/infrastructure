...
writing that is a nonlinear representation of a conversation. Ward
Cunningham and other more organizationally-oriented contributors opposed
ThreadMode (eg.
...
\href{https://meta.wikimedia.org/wiki/Special:MyLanguage/Deletionism}{Deletionists}
vs.~the
...
``one big movement'' \cite{kleinWereDCSeattle2001} . Murray
Bookchin describes:
...
group projects that interest them. \cite{freemanTyrannyStucturelessness1970} 
\end{quote}
