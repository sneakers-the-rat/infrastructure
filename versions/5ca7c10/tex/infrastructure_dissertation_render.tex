...
\includegraphics[width=\linewidth]{./infrastructure/assets/images/clark-slide.png} \emph{A
...
regarding effort duplication\sidenote{Thanks a lot to the one-and-only
...
\href{https://github.com/BrainCOGS}{public}\sidenote{\begin{quote}
...
Seemingly prosocial protocols can be used by industries to pre-empt an
...
\includegraphics[width=\linewidth]{./infrastructure/assets/images/kanye-what.png} \emph{The
...
translation between biomedical data is impossible\sidenote{\begin{quote}
...
\href{https://arax.ncats.io/?r=52703}{treatments for gender identity
disorder} helpfullly yielded ``zinc'' and ``water,'' offering a paper
...
communication\sidenote{For a recent example, see the responses to Dan
  ...
  review altogether \citep{dangoodman{[}neuralreckoning{]}CurrentSystemJournals2022
  goodmanEndingSupportLegacy2022 } }. The belief that peer review as
...
\href{http://wiki.c2.com/?WhyWikiWorks}{WhyWikiWorks}\sidenote{Interestingly,
